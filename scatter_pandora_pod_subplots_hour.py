...
Scatter the Pandora & ground data, colored by hour of day
...
for n in range(len(pollutants)):
    ...
    for k in range(len(locations)):
        ...
        sc = axs[k].scatter(merge['{}'.format(pollutants[n])], merge['Pandora {} {}'.format(typeLabel[n],pollutants[n])],c=merge['Hour'], s=25)
